...
class MpApplicationTests {
    ...
    public void testFill(){
        ...
        userInfo.setId(Long.parseLong("007"));
        userInfo.setAge(23);
        userInfo.setName("hik");
        userInfo.setEmail("renpeiqian@hikvision.com");
       ...
       userInfo.setEmail("rpqx637@163.com");
    ...
    /**
     * 代码生成器 自动生成entity、mapper、controller、sevice
     */
    @Test
    public void test(){
        // Step1：代码生成器
